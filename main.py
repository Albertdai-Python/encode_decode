...
def decipher_str(code_str:str, key_str:str):
	...
	return decipher_str
print(decipher_str(cipher_str("i am a good boy", "123qwe"), "123qwe"))
#print(cipher_str("12wew3qwe", "123qwe"))
#print(decipher_str("000000/001011/000001/0000011/0000011/0011100/", "1j7e.;"))